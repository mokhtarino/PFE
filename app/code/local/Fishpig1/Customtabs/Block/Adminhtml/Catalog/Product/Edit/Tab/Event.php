<?php
/**
 * app/code/local/MasteringMagento/customtabs/Block/Adminhtml/Catalog/Product/Edit/Tab/Event.php
 *
 ...
 */
class Fishpig_Customtabs_Block_Adminhtml_Catalog_Product_Edit_Tab_Event
    extends Mage_Adminhtml_Block_Widget implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('customtabs')->__('Event Information');
    }
    ...
    public function getAddButtonHtml()
    {
        $addButton = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('customtabs')->__('Add New Ticket'),
                'id'    => 'add_ticket_item',
                'class' => 'add'
            ));
